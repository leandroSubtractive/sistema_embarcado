...
//        val intent = Intent().apply { Intent.setAction = Constants.MusicConstants.ACTION_PLAY }
//
...
//        val intent = Intent().apply { Intent.setAction = Constants.MusicConstants.ACTION_PAUSE }
//
//        service.onStartCommand(intent, 0, 0)
//
...
//            Intent.setAction = Constants.MusicConstants.ACTION_SEEK_TO
//            putExtra(Constants.MusicConstants.EXTRA_SEEK_POSITION, 5000)
//        }
//
//        service.onStartCommand(intent, 0, 0)
//
...
//        val intent = Intent().apply { Intent.setAction = Constants.MusicConstants.ACTION_NEXT }
//
//        service.onStartCommand(intent, 0, 0)
//
...
//        val intent = Intent().apply { Intent.setAction = Constants.MusicConstants.ACTION_PREVIOUS }
//
//        service.onStartCommand(intent, 0, 0)
//
//        verify(mockPlayback).setRawDataSource(anyInt())
